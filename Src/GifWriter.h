...
class GifWriter {
public:
	typedef Array2D<Color> ArrayType;
	...
	bool GifWriteFrame(const ArrayType &fImage, int bitDepth = 8, bool dither = false);
...
private:
	...
	void GifMakePalette(const uint8_t* lastFrame, const ArrayType &nextFrame, int bitDepth, bool buildForDither, GifPalette* pPal);
